<script src="https://kit.fontawesome.com/4b81a205ee.js" crossorigin="anonymous" defer>
	...
	let settings = {"setter":0,"allSettings":[],"comments":[],"burger_menu_show":10000,"headers":{"main_headers":[], "additional_headers":[]},"footer":{"main_footers":[],"social_media_footers":[],"contact_footer":"", "copyright":""},"main_elements":[], "articles":[],"gallery":[{"src":"","title":""}]}
	$: innerWidth = 0
 ...
 <svelte:window bind:innerWidth />
  <Router>
 	<main style="background-color: {settings.bg_color}" class:fun-class-name-owo={settings.menu_version==1 && innerWidth > settings.burger_menu_show} class:fun-class-name-uwu={settings.menu_version==1 && innerWidth < settings.burger_menu_show}>
